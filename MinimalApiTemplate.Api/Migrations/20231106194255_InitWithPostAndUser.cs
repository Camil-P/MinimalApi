...
{
    /// <inheritdoc />
    public partial class InitWithPostAndUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmation = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Banned = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
